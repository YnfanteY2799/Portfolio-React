    ...
    <>
            ...
            <div className="flex items-center">
              <Link to="/About">
                <Button
                  title="More Details !"
                  // type="button"
                  // className="lg:block text-gray-500 hover:text-gray-900 hover:bg-gray-100 p-2 rounded-lg"
                />
              </Link>
            </div>
          </div>
      ...
      <>
        ...
        <aside
          ...
          aria-label="Sidebar"
        >
          <div className="hidden relative flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white pt-0">
